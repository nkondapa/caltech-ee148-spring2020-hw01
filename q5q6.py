...
selected_files = ['RL-001.jpg', 'RL-010.jpg', 'RL-031.jpg', 'RL-024.jpg', 'RL-004.jpg', 'RL-048.jpg']

preds = {}
for i in range(len(selected_files)):

    # read image using PIL:
    I = Image.open(os.path.join(data_path, selected_files[i]))

    # convert to numpy array:
    I = np.asarray(I)

    preds[selected_files[i]] = detect_red_light(I, selected_files[i])
